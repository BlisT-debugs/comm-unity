                ...
                <TabsContent value="general" className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        {t('Set your default location for contextual search and issue reporting')}
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <Label htmlFor="location">{t('Your Location')}</Label>
                        <div className="flex gap-2">
                          <Input 
                            id="location" 
                            value={location || ''}
                            onChange={(e) => setLocation(e.target.value)}
                            placeholder={t('Enter your city or region')}
                          />
                          <Button 
                            variant="outline"
